  ...
  return (
    <section id="contact" className="bg-white px-10 py-16 scroll-mt-24">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
        ...
        <div>
          <p className="text-base font-bold uppercase tracking-widest text-[#E8951A] mb-3">Get started</p>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-sm bg-[#E8951A] flex items-center justify-center flex-shrink-0">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-sm p-8">
          {status === 'success' ? (
            <div className="text-center py-12">
              <div className="w-16 h-16 rounded-full bg-[#E8951A] flex items-center justify-center mx-auto mb-4">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              <div>
                ...
                <input name="name" type="text" placeholder="John Smith" required
                  className="w-full px-4 py-3 border border-gray-200 rounded-sm text-sm bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:border-[#E8951A]" />
              </div>
              ...
              <div>
                ...
                <select name="service" required
                  className="w-full px-4 py-3 border border-gray-200 rounded-sm text-sm bg-white text-gray-900 focus:outline-none focus:border-[#E8951A]">
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-200 rounded-sm p-6 text-center cursor-pointer hover:border-[#E8951A] transition-colors bg-white">
                  <input name="photos" type="file" accept="image/*" multiple className="hidden" id="photos" />
                  <label htmlFor="photos" className="cursor-pointer">
                    <p className="text-sm text-gray-500">
                      <span className="text-[#E8951A] font-semibold">Click to upload</span> or drag & drop
                    </p>
              ...
              <div>
                ...
                <textarea name="description" rows={3} placeholder="Describe the work needed, approximate area size, timeline..." required
                  className="w-full px-4 py-3 border border-gray-200 rounded-sm text-sm bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:border-[#E8951A] resize-none" />
              </div>
              <button type="submit" disabled={status === 'sending'}
                className="w-full py-4 bg-[#E8951A] text-white text-sm font-bold uppercase tracking-widest rounded-sm hover:bg-[#d4841a] transition-colors disabled:opacity-50">

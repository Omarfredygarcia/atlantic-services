  ...
  return (
    <section className="min-h-[600px] flex items-center relative overflow-hidden">
      ...
      <div className="relative z-10 px-6 md:px-16 py-16 md:py-20 max-w-4xl">
        ...
        <p className="text-base md:text-xl font-light text-white/75 leading-relaxed mb-8 md:mb-10 max-w-2xl">
        ...
        <div className="flex gap-4 flex-wrap">
          ...
          <a href="/gallery" className="px-8 py-3 md:px-10 md:py-4 border-2 border-white/40 text-white text-sm font-medium uppercase tracking-wider rounded-sm hover:border-[#E2B84A] hover:text-[#E2B84A] transition-colors">
            View Our Work →
          </a>
        </div>
      </div>

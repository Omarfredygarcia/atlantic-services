  ...
  return (
    <footer className="bg-[#3D4F5C] px-10 py-12">
      <div className="flex flex-col md:flex-row justify-between items-start gap-10 mb-10">
        ...
        <div>
          <p className="text-sm font-bold uppercase tracking-widest text-[#E2B84A] mb-4">Navigation</p>
          <div className="flex flex-col gap-3">
            <span className="text-base text-white/70 cursor-pointer hover:text-[#E2B84A] transition-colors">Services</span>
            <span className="text-base text-white/70 cursor-pointer hover:text-[#E2B84A] transition-colors">Projects</span>
            <span className="text-base text-white/70 cursor-pointer hover:text-[#E2B84A] transition-colors">About</span>
            <span className="text-base text-white/70 cursor-pointer hover:text-[#E2B84A] transition-colors">Contact</span>
          </div>
        </div>
        <div>
          <p className="text-sm font-bold uppercase tracking-widest text-[#E2B84A] mb-4">Contact</p>
          <div className="flex flex-col gap-3">
        ...
        <div>
          <p className="text-sm font-bold uppercase tracking-widest text-[#E2B84A] mb-4">Hours</p>
          <div className="flex flex-col gap-3">

  ...
  return (
    <section id="services" className="py-20 bg-gray-50 scroll-mt-24">
      <div className="text-center mb-14 px-10">
        <p className="text-sm font-bold uppercase tracking-widest text-[#E2B84A] mb-3">What we do</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 px-6 md:px-10">
        {services.map((service, index) => (
          <div key={index}
            className="group relative overflow-hidden rounded-sm cursor-pointer border-2 border-transparent hover:border-[#E2B84A] hover:shadow-xl transition-all duration-300">
            ...
            <div className="relative aspect-[4/3] overflow-hidden">
              ...
              <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center">
                  <svg viewBox="0 0 24 24" fill="none" stroke="#E2B84A" strokeWidth="2.5" className="w-4 h-4">

  ...
  return (
    <section id="services" className="py-20 bg-gray-50 scroll-mt-24">
      <div className="text-center mb-14 px-10">
        <p className="text-sm font-bold uppercase tracking-widest text-[#E8951A] mb-3">What we do</p>
        ...
        {services.map((service, index) => (
          <div key={index}
            ...
            <div className="relative aspect-[4/3] overflow-hidden">
              ...
              <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center">
                  <svg viewBox="0 0 24 24" fill="none" stroke="#E8951A" strokeWidth="2.5" className="w-4 h-4">
            ...
            <div className="p-5 bg-white">
              <h3 className="font-serif text-lg font-semibold text-gray-900 mb-2 group-hover:text-[#E8951A] transition-colors">{service.title}</h3>

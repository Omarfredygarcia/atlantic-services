    ...
    <main>
      ...
      <section className="bg-black py-24 px-10">
        <div className="max-w-4xl">
          <p className="text-sm font-bold uppercase tracking-widest text-[#C9A84C] mb-4">Our company</p>
          <h1 className="font-serif text-6xl font-semibold text-white leading-tight mb-6">
            Built on Integrity.<br />Driven by <em className="text-[#C9A84C] not-italic">Excellence.</em>
          </h1>
      ...
      <section className="bg-white py-20 px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          <div>
            <p className="text-sm font-bold uppercase tracking-widest text-[#C9A84C] mb-4">Our story</p>
      ...
      <section className="bg-[#3D4F5C] py-20 px-10">
        <div className="text-center mb-14">
          <p className="text-sm font-bold uppercase tracking-widest text-[#C9A84C] mb-3">What drives us</p>
